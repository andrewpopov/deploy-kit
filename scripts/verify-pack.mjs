...
try {
  ...
  const smoke = `
    ...
    const expected = ['deploy', 'loadConfig', 'mergeConfig', 'runOnTarget', 'buildTargetCommand', 'startTunnel', 'makeLogger'];
  ...
  const esmSmoke = `
    ...
    const named = ['deploy', 'loadConfig', 'runOnTarget', 'startTunnel'];
